...
name_output <- paste0(mutant_level, "_vs_", ref_level)
output_file_name <- file.path(absolute_path5, paste0(name_output, ".txt"))
write(name_output, file = output_file_name, append = TRUE)
...
name_down <- paste0(mutant_level, "_vs_", ref_level, "_signif-down-regulated.txt")
...
name_up <- paste0(mutant_level, "_vs_", ref_level, "_signif-up-regulated.txt")
